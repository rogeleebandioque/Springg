...
public class Operations {
    ...
    String words = "<table border=\"1\"align=\"center\"><tr><th colspan=\"5\">"+ "Searched Person " + 
    ...
    public String displayPerson(List<Person> person, String by) {
        String words = "<table border=\"1\"align=\"center\"><tr><th colspan=\"5\">"+ "LIST: PERSON by " + by + 
                        "</th></tr><tr><th>ID</th><th>Name</th><th>Grade</th><th>Date Hired</th><th>Contact Number</th></tr>";
    ...
    public String createFields(){
        String fields = "</br><form>" + 
                        "<input type=\"button\" value=\"Add Person\" onClick=\"location.href='AddPerson.html'\"> &nbsp;&nbsp;" +
                        "<input type=\"button\" value=\"Delete Person\" onClick=\"location.href='DeletePerson.html'\"> &nbsp;&nbsp;" +
                        "<input type=\"button\" value=\"Edit Person\" onClick=\"location.href='EditPerson.html'\">" +
                        "</form></br>";
    ...
    public String listBy(){
        String order = "</br>VIEW:<form><input type=\"radio\" name=\"view\" onclick=\"listTo('person')\"/> Person &nbsp;&nbsp" +
                       ...
                       "<form action=\"Servlets\" method=\"POST\" id=\"displist\"onSubmit=\"return checkList()\">" +
                       " </form>" ; 
        return order;
    }
